...
public class OrganizationBLService_Driver {
	...
	public void drive(OrganizationBLService organizationBLService){
		...
		result = organizationBLService.add(new OrganizationVO("北京", OrganizationType.BUSINESSHALL, "001"));
		...
		ArrayList<OrganizationVO> list2 = organizationBLService.findByCity("北京");
		...
		int distance = organizationBLService.showDistance(new OrganizationVO("北京", OrganizationType.BUSINESSHALL, "001"), new OrganizationVO("北京", OrganizationType.BUSINESSHALL, "002"));
