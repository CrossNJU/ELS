...
public class InfoItemLabel extends ELSLabel{
	...
	public InfoItemLabel() {
		...
		this
				.setMaximumSize(new Dimension(UIConstant.CONTAINER_WIDTH, UIConstant.MANAGETABLE_ITEM_HEIGHT));
		this
				.setMinimumSize(new Dimension(UIConstant.CONTAINER_WIDTH, UIConstant.MANAGETABLE_ITEM_HEIGHT));
	}
