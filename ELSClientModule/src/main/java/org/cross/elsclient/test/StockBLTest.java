...
public class StockBLTest {
	...
	public static void main(String[] args) throws RemoteException{
		...
		stockVO.usedAreas = 3;
		StockAreaVO area1 = new StockAreaVO("000001", StockType.COMMON, 1);
//		StockAreaVO area2 = new StockAreaVO("000002", StockType.COMMON, 1);
		StockAreaVO area3 = new StockAreaVO("000003", StockType.ECONOMICAL, 1);
		StockAreaVO area4 = new StockAreaVO("000004", StockType.Fast, 1);
...
//		}
		...
		ResultMessage intoStockMessage = stockBLImpl.intoStock("G003", "S0002","2015-11-2 11:34:21");
