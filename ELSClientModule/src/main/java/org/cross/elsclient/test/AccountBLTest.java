...
public class AccountBLTest {
	...
	public static void main(String[] args) throws RemoteException{
		...
		AccountVO vo1 = new AccountVO("account1", "325715400091", 367.2);
...
//		ResultMessage deleteMessage = accountBLImpl.delete("325715400099");
...
//		}
		...
		AccountVO vo2 = accountBLImpl.findByID("325715400099");
		if (vo2 != null) {
		...
		AccountVO newVo = new AccountVO("account1", "325715400099", 113367.2);
