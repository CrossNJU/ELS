...
public class OrganizationBLTest {
	public static void main(String[] args) throws RemoteException{
		...
		OrganizationVO newOrg = new OrganizationVO(City.BEIJING, OrganizationType.BUSINESSHALL, "002333");
...
//		ResultMessage delMessage = orgBLImpl.delete("002311");
...
//		}
		...
		OrganizationVO updateOrg = new OrganizationVO(City.SHANGHAI, OrganizationType.HEADQUARTERS, "002311");
		...
		OrganizationVO idOrg = orgBLImpl.findById("002311");
		if (idOrg != null) {
			System.out.println(idOrg.id + " " + idOrg.city + " " + idOrg.type);
		}else {
			System.out.println("查找失败");
		}
		System.out.println("========测试showDistance=======");
