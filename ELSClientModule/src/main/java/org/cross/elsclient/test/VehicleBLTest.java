...
public class VehicleBLTest {
	...
	public static void main(String[] args) throws RemoteException{
		...
		VehicleInfo vehicleInfo = new VehicleInfoImpl(dataFactory.getVehicleData());
		VehicleBLImpl vehicleBLImpl = new VehicleBLImpl(dataFactory.getVehicleData(), vehicleInfo);
		
		System.out.println("=======测试增加车辆信息（add）=======");
		VehicleVO vehicleVO = new VehicleVO("V01025001", "E72687999", "O02501112", "3265732752", "B6526", "2011-10-2", "2019-2-1", null, false);
