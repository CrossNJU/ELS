...
public class UserBLTest {
	...
	public static void main(String[] args) throws RemoteException {
		...
		UserVO newVo = new UserVO("U01025003", "陈丹妮3", "O02501002",
				PositionType.ADMINISTRATOR.toString(), "123321");
		...
		UserVO upDateVo = new UserVO("U01025001", "陈丹妮1", "O025010222",
				PositionType.BUSINESSHALLCLERK.toString(), "123321");
		...
		if (size == 0) {
		 ...
		 ArrayList<UserVO> typeVo =
		 userBLImpl.findByType(UserType.ADMINISTRATOR);
		 if (typeVo != null) {
		 int size1 = typeVo.size();
		 for (int i = 0; i < size1; i++) {
		 System.out.println(typeVo.get(i).number + " " + typeVo.get(i).name + " "
